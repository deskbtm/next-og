...
const OpenGraphContext = createContext({});
const OpenGraphProvider = function(props) {
  const { children, head, ...rest } = props;
  return /* @__PURE__ */ React.createElement(OpenGraphContext.Provider, { value: rest }, children);
};
...
const render = (props, context) => {
  ...
  if (absoluteUrl) {
    tags.push(
      /* @__PURE__ */ React.createElement("meta", { key: "meta-og-url", property: "og:url", content: absoluteUrl })
    );
  }
  if (type) {
    tags.push(/* @__PURE__ */ React.createElement("meta", { key: "meta-og-type", property: "og:type", content: type }));
  }
  if (title) {
    tags.push(
      /* @__PURE__ */ React.createElement("meta", { key: "meta-og-title", property: "og:title", content: title }),
      /* @__PURE__ */ React.createElement("meta", { key: "meta-twitter-title", name: "twitter:title", content: title })
    );
  }
  if (siteName) {
    tags.push(
  ...
  if (description) {
    tags.push(
      /* @__PURE__ */ React.createElement("meta", { key: "meta-description", name: "description", content: description }),
      /* @__PURE__ */ React.createElement(
        "meta",
        {
  ...
  if (locale) {
    tags.push(
      /* @__PURE__ */ React.createElement("meta", { key: "meta-og-locale", property: "og:locale", content: locale })
    );
  }
  if (Array.isArray(localeAlternates)) {
    tags.push(
      ...localeAlternates.map((localeAlternate) => /* @__PURE__ */ React.createElement(
        "meta",
        {
...
const OpenGraphHead = function(props) {
  ...
  return /* @__PURE__ */ React.createElement(Head, null, render(props, context));
};

export { OpenGraphContext, OpenGraphHead, OpenGraphProvider };
